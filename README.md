...
## Results
  - Results of PyBer ride-sharing analyses based on city types are shown as below:
    ...
    Overall, ride-sharing is more common in urban city, whereas barely seen in rural city. In the meantime, for either fare per ride or fare per driver, average fares in urban city, are much lower than suburban and rural city.     
